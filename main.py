...
from src.fundamental_diagram import (
    compute_density,
    plot_fundamental_diagrams,
    fit_and_plot_greenshields,
)
...
def main():
    data_path = (
        ...
        r"C:\Users\31078\Desktop\ngsim-traffic-analysis\data\NGSIM\US-101-Main-Data\vehicle-trajectory-data\0805am-0820am\trajectories-0805am-0820am.txt"  # 数据文件的绝对路径（原始 NGSIM 轨迹数据）
    )
    lane_id = 2  # 要分析的车道 ID
